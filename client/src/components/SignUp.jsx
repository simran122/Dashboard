                ...
                <Box sx={{ display: "flex", alignItems: { xs: "flex-start", sm: "center" }, flexDirection: "column", bgcolor: "#F5F5F5", justifyContent: "center", minWidth: "65%", mt: { xs: "6rem", sm: 0 }, mx: "auto", minHeight: "100%" }}>
                    <Box sx={{
                        ...
                        <Box sx={{ display: "flex", flexWrap: "wrap", gap: "2rem", }}>
                            ...
                            <Box onClick={facebookSign} sx={{ display: "flex", gap: 1, alignItems: "center", bgcolor: "white", border: "1px solid transparent", p: "0.5rem 1rem", borderRadius: "15px", maxWidth: { xs: "28rem", sm: "15rem" }, justifyContent: "center", flexGrow: 1 }}>
